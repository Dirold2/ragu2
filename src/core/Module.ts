...
export abstract class Module extends EventEmitter implements BaseModule {
    ...
    public get name(): string { return this.metadata.name; }
    public get description(): string { return this.metadata.description; }
    public get version(): string { return this.metadata.version; }
    public get dependencies(): string[] { return this.metadata.dependencies; }
    public get disabled(): boolean { return this.metadata.disabled; }
    public get priority(): number { return this.metadata.priority; }
    public get state(): ModuleState { return this._state; }
